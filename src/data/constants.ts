...
using use = useUsing("use")`,
  ...
  [SkillNames.TAILWIND]: {
    ...
    name: "tailwind",
    label: "Tailwind CSS",
    shortDescription: "inline style chaos, but lowkey make it fashion! 💅✨",
    color: "#38bdf8",
  ...
  [SkillNames.NODEJS]: {
    ...
    label: "Node.js",
    shortDescription:
      "JavaScript said 'I can do backend', and honestly, it's serving! 💅✨",
    color: "#68a063",
  ...
  [SkillNames.EXPRESS]: {
    ...
    name: "express",
    label: "Express",
    shortDescription: "the backend bestie, keeping it simple, periodt! 🤝💻",
    color: "#000000",
  ...
  [SkillNames.POSTGRES]: {
    ...
    label: "PostgreSQL",
    shortDescription:
      "the database that's built different, straight up goated! 🐘💯",
    color: "#336791",
  ...
  [SkillNames.MONGODB]: {
    ...
    label: "MongoDB",
    shortDescription:
      "storing data like it's nobody's business, no cap! 🍃📊",
    color: "#4db33d",
  ...
  [SkillNames.GIT]: {
    ...
    name: "git",
    label: "Git",
    shortDescription: "keeping my code in check, literally! 📝🔗",
    color: "#f14e32",
